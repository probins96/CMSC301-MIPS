...
Opcode OpcodeTable::getOpcode(string opcode_field, string func_field) {
...
string OpcodeTable::getOpcodeName(Opcode o) {
  // If the instruction isn't an RTYPE, we can use the unique opcode field to get the name
